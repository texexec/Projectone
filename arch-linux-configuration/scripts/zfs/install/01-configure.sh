...
then
  ...
  ask "0) us   1) de-latin1   2) input your own"
...
then
  ...
  ask "0) en_US.UTF-8   1) de_DE   2) input your own"
...
then
  ...
  ask "0) Asia/Seoul   1) Europe/Berlin   2) input your own"
  ...
  case ${REPLY} in
    ...
    1)
      ...
      ;;
    2)
      ask "Please insert your timezone"
      timezone="${REPLY}"
      ;;
    *)
      timezone="Asia/Seoul"
